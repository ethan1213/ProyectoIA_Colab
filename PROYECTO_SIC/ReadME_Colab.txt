...
## Codigos Adicionales Colab
- Modelos_Combinados_DetectVoice: Combina los modelos ya entrenados de RNN_CNN_DetectVoice.ipynb y DetectVoice.ipynb dando una respuesta mas exacta
- RNN_CNN_DetectVoice.ipynb : Es la segunda Version de DetectVoice.ipynb donde se junta RNN y CNN en el codigo para la verificacion de las voces (Todavia en proceso de mejora).
- DetectVoice.ipynb : Es el codigo principal para la verificacion de voces y hasta ahora la mas efectiva.
- Creacion_DF_IA_y_Reales: Crea un DF de todos los auidios de IA y de los audios Reales dejandolos listos para los programas tanto de DetectVoice.ipynb como RNN_CNN_DetectVoice.ipynb
- N_Clips_DetectVoice : Separa videos en clips de 10 a 50 segundos cada uno de manera aleatoria y guardandolos en la carpeta predestinada.
- modelo_RNN_CNN_DetectVoice_00.h5 : es el modelo entrenado de  RNN_CNN_DetectVoice.ipynb con un 95% de precision y 5% de perdida.
- modelo_CNN_DetectVoice_00.h5 : es el modelo entrenado de DetectVoice.ipynb con un 98% de precision y 2% de perdida.
